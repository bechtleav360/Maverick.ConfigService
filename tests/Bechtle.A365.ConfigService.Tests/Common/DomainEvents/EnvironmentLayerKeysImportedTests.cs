...
namespace Bechtle.A365.ConfigService.Tests.Common.DomainEvents
{
    public class EnvironmentLayerKeysImportedTests
    {
        ...
        {
            var left = new EnvironmentLayerKeysImported(new LayerIdentifier(layerName), actions);
            var right = new EnvironmentLayerKeysImported(new LayerIdentifier(layerName), actions);
        ...
        {
            var domainEvent = new EnvironmentLayerKeysImported(new LayerIdentifier(layerName), actions);
