...
{
    public class EnvironmentKeysImportedTests
    {
        ...
        {
            var left = new EnvironmentKeysImported(new EnvironmentIdentifier(envCategory, envName), actions);
            var right = new EnvironmentKeysImported(new EnvironmentIdentifier(envCategory, envName), actions);
        ...
        {
            var domainEvent = new EnvironmentKeysImported(new EnvironmentIdentifier(envCategory, envName), actions);
